  ...
  return (
    <div style={{
      ...
      <div className="fade-up" style={{
        ...
        {[
          { label: 'Name', val: name, set: setName, ph: 'Your name', type: 'text' },
          ...
          <div key={f.label} style={{ marginBottom: '14px' }}>
            <div style={{ fontSize: '11px', color: 'var(--text2)', marginBottom: '5px' }}>{f.label}</div>
            <input
              type={f.type}
              style={inputStyle}
              placeholder={f.ph}
        ...
        <div style={{ textAlign: 'center', marginTop: '18px', fontSize: '12px', color: 'var(--text3)' }}>
          Already registered?{' '}
          <Link to="/login" style={{ color: '#fbbf24' }}>Log in</Link>
        </div>
